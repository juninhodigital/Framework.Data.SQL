CREATE DATABASE [DB_SYSADV] ON  PRIMARY 
( 
	NAME = N'DB_SYSADV', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\DB_SYSADV.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
	LOG ON ( NAME = N'DB_SYSADV_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\DB_SYSADV_log.ldf' , SIZE = 3456KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [DB_SYSADV] SET COMPATIBILITY_LEVEL = 100
GO
...
(
 ...
 END
GO
ALTER DATABASE [DB_SYSADV] SET  READ_WRITE 
GO