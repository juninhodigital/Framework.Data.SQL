...
namespace Framework.Data.SQL
{
    ...
    public struct CommandDefinition
    {
        ...
        /// </summary>
        public bool Buffered => (Flags & CommandFlagsEnumerator.Buffered) != 0;

        /// <summary>
        /// Should the plan for this query be cached?
        /// </summary>
        internal bool AddToCache => (Flags & CommandFlagsEnumerator.NoCache) == 0;

        /// <summary>
        /// Additional state flags against this command
        /// </summary>
        public CommandFlagsEnumerator Flags { get; }

        /// <summary>
        /// Can async queries be pipelined?
        /// </summary>
        public bool Pipelined => (Flags & CommandFlagsEnumerator.Pipelined) != 0;
        ...
        public CommandDefinition(string commandText, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null,
                                 CommandType? commandType = null, CommandFlagsEnumerator flags = CommandFlagsEnumerator.Buffered
